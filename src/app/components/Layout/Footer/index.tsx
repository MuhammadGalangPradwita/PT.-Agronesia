  ...
  return (
    <footer className='bg-deep-slate pt-10'>
      <div className='container'>
            ...
            <div className='flex flex-col gap-10'>
              <div className='flex item-center'>
                ...
                <p className='text-black text-base'>
                  Jl. Aceh No. 30 Bandung, 40117, Indonesia
                </p>
              </div>
              ...
              <Link href='/' className='flex items-center w-fit'>
                ...
                />
                <p className='text-black/60 hover:text-primary text-base'>
                  sekretariat.pusat@ptagronesia.com
                </p>
              </Link>
            </div>
          </div>
        ...
        <div className='mt-10 lg:flex items-center justify-center border-t border-black/10 py-5'>
          <p className='text-black/50 text-base text-center lg:text-start font-normal'>
            @2025 PT. Agronesia. All Rights Reserved{' '}
          </p>
